...
int main()
{
	float week1, week2, week3, avgSpent, totalSpent = 0.0; 
	...
	totalSpent = week1 + week2 + week3;
	avgSpent = totalSpent / 3; 
	...
	else if (week1 >= 50 && week1 < 200 || week2 >= 50 && week2 < 200 || week3 >= 50 && week3 < 200)
	{
		printf("You are eating well!");
	}
	else if (week1 > 200 || week2 > 200 || week3 > 200)
	{
		printf("You spent: $%.2f\n", totalSpent);
